...
(function () {
  ...
  function getCardsForOrderExport(order, state) {
  ...
  function markExported(orderId, exported) {
    trackerState = {
      ...trackerState,
      [orderId]: { ...trackerState[orderId], exported },
    };
  }
  ...
  function renderOrderCard(order, today) {
    ...
    exportSingleBtn.addEventListener('click', async (event) => {
      ...
      const orderCards = getCardsForOrderExport(order, trackerState);
  ...
  exportBtn.addEventListener('click', async () => {
    const includeExported = exportIncludeExported ? exportIncludeExported.checked : false;
    const receivedCards = getReceivedCardsForExport(orders, trackerState, includeExported);
